...
<?php
  ...
  if(isset($_SESSION["FatherName"])||isset($_SESSION["Gname"])||isset($_SESSION["Sname"])||isset($_SESSION["gender"])||isset($_SESSION["Mname"])||isset($_SESSION["ApName"])){
...
<table>
  ...
  <tr>
    ...
    <td><pre>Height:<span style="color:#f00">*</span>                 <input type="text" name ="Height" >cm<input type="text" name ="Height" >inch</pre></td>
